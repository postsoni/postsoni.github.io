...
const translations = {
    ja: {
        ...
        nav: {
            top: 'TOP', news: '最新の活動報告', gallery: '活動ギャラリー',
            roadmap: '初めての方へ', profile: 'プロフィール', sns: 'SNS',
            activity: 'ブログアクセス', 'edgetx-manual': 'EdgeTXマニュアル', 'ai-games': 'AIラジコンゲーム', goods: 'グッズ', support: 'RC支援・サポート',
    ...
    en: {
        ...
        nav: {
            ...
            activity: 'Blog', 'edgetx-manual': 'EdgeTX Manual', 'ai-games': 'AI RC Games', goods: 'Goods', support: 'Support',
    ...
    zh: {
        ...
        nav: {
            ...
            activity: '博客', 'edgetx-manual': 'EdgeTX手册', 'ai-games': 'AI遥控游戏', goods: '商品', support: '支援',
