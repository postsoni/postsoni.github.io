...
const translations = {
    ja: {
        ...
        archiveProject: {
            date: '2025年11月27日',
            title: 'RCアーカイブプロジェクト始動 - 36機種のデータベース化完了',
            overviewTitle: '📚 プロジェクト概要',
            ...
            currentStatusItem1: '登録機種数: 36機種',
            currentStatusItem2: '対応メーカー: タミヤ、京商、JR PROPO',
            currentStatusItem3: 'カテゴリー: ラジコンカー（33機種）、ラジコン飛行機（1機種）、ラジコンヘリ（2機種）',
            featuresTitle: '✨ 主な機能',
    ...
    en: {
        ...
        archiveProject: {
            ...
            title: 'RC Archive Project Launch - Database of 36 Models Completed',
            overviewTitle: '📚 Project Overview',
            ...
            currentStatusItem1: 'Registered Models: 36 models',
            currentStatusItem2: 'Supported Manufacturers: Tamiya, Kyosho, JR PROPO',
            currentStatusItem3: 'Categories: RC Cars (33 models), RC Airplanes (1 model), RC Helicopters (2 models)',
    ...
    zh: {
        ...
        archiveProject: {
            ...
            currentStatusItem1: '登记机型数：36款',
            currentStatusItem2: '支持制造商：田宫、京商、JR PROPO',
            currentStatusItem3: '类别：遥控车（33款）、遥控飞机（1款）、遥控直升机（2款）',
            featuresTitle: '✨ 主要功能',
