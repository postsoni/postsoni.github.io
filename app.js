...
const translations = {
    ja: {
        ...
        edgetxManualSection: {
            ...
            pdfInfo: 'Version 1.0.1 | 全56ページ | 約280KB',
            pdfDate: '発行日：2026年1月',
            pdfButton: '📥 PDFをダウンロード',
            updateTitle: 'v1.0.2 修正記事',
            updateInfo: 'Version 1.0.2 | 全3ページ | 約74KB',
            updateDate: '発行日：2026年4月',
            updateButton: '📥 修正記事をダウンロード',
            ...
            changelogEntry2: '2026年4月26日 - Version 1.0.2 公開',
        ...
        rcLibrarySection: {
            ...
            elrsTitle: '📻 ELRSについて',
            elrs01Title: 'ELRS 入門ガイド 〜初めて学ぶ人が知らなければならないこと〜',
            elrs01Desc: 'ELRSの基本概念から、パケット構造・チャンネルモード・ヘリコプター向け設定まで解説。Rotorflightでのチャンネルマッピング変更手順、バージョン管理の注意点も収録。',
            elrs01Meta: '全6ページ | 約423KB',
            updateTitle: '📡 各種アップデート用設定まとめ',
            update03Title: 'ELRS 4.0.1 更新情報まとめ（v4.0.0→v4.0.1）',
            update03Desc: 'ExpressLRS 4.0.1への更新内容を解説。SX1280のTX/RX FIFO分離（Rotorflightフェイルセーフ・再接続不能問題の修正）、TX16S/Zorroの出力正常化、SubGHz規制ドメイン表示・ESP32C3パルスなしフェイルセーフの修正。誰に該当するかの判定表、開発者への感謝・自己責任の方針も収録。',
            update03Meta: '全4ページ | 約76KB',
            update02Title: 'EdgeTX v2.12.0 変更点まとめ（v2.11.5→v2.12.0）',
            update02Desc: 'EdgeTX v2.12.0 "Queen Anne\'s Revenge" の変更点をまとめた資料。STM32F2機のサポート終了、TX16S MK3対応、UIテーマ対応、起動高速化、CRSF速度制限修正、Companion改善など。TX16S Mk2ユーザー向けの影響まとめも収録。',
            update02Meta: '全4ページ | 約81KB',
        ...
        topSection: {
            ...
            stat4Number: '3年間', stat4Label: 'サポート活動',
            monthlyTitle: '📅 今月の活動',
            monthlyUpdated: '2025年3月8日更新',
            monthlyRepairsTitle: '修理・改善されたラジコン',
            monthlyRepairsCount: '5台',
            monthlySupportedTitle: 'サポートした人数',
            monthlySupportedCount: '5名',
            monthlyNewModelTitle: '新作機体',
            monthlyNewModelDetail: 'GOOSKY RS7 Ultra',
            monthlyNewsTitle: '新着その他情報',
            monthlyNewsDetail: 'TX16S mk2の詳細解説、GOOSKY RS7 Ultraの詳細理解、TX16S mk3やその他新作情報への知見、ELRSシステムの詳細理解（4.0.0対応）、X（旧Twitter）にて交流を広げられた',
    ...
    en: {
        ...
        edgetxManualSection: {
            ...
            pdfInfo: 'Version 1.0.1 | 56 Pages | ~280KB',
            pdfDate: 'Published: January 2026',
            pdfButton: '📥 Download PDF',
            updateTitle: 'v1.0.2 Update Notice',
            updateInfo: 'Version 1.0.2 | 3 Pages | ~74KB',
            updateDate: 'Published: April 2026',
            updateButton: '📥 Download Update',
            ...
            changelogEntry2: 'Apr 26, 2026 - Version 1.0.2 Released',
        ...
        rcLibrarySection: {
            ...
            elrsTitle: '📻 About ELRS',
            elrs01Title: 'ELRS Beginner\'s Guide — What You Need to Know First',
            elrs01Desc: 'Covers ELRS fundamentals including packet structure, channel modes, and helicopter-specific settings. Includes Rotorflight channel mapping instructions and version compatibility notes.',
            elrs01Meta: '6 Pages | ~423KB',
            updateTitle: '📡 Firmware & Software Update Guides',
            update03Title: 'ELRS 4.0.1 Update Summary (v4.0.0 → v4.0.1)',
            update03Desc: 'Summary of changes in ExpressLRS 4.0.1. Covers SX1280 TX/RX FIFO separation (fixing Rotorflight failsafe and reconnection issues), TX16S/Zorro output accuracy correction, SubGHz regulatory domain display fix, and ESP32C3 no-pulse failsafe fix. Includes a "who should update" table and notes on developer acknowledgment and self-responsibility.',
            update03Meta: '4 Pages | ~76KB',
            update02Title: 'EdgeTX v2.12.0 Changes Summary (v2.11.5 → v2.12.0)',
            update02Desc: 'Summary of changes in EdgeTX v2.12.0 "Queen Anne\'s Revenge". Covers STM32F2 radio support removal, TX16S MK3 support, UI theme customization, faster boot times, CRSF speed limit fix, Companion improvements, and more. Includes a TX16S Mk2-specific impact summary.',
            update02Meta: '4 Pages | ~81KB',
        ...
        topSection: {
            ...
            stat4Number: '3 Years', stat4Label: 'Support Activity',
            monthlyTitle: '📅 This Month',
            monthlyUpdated: 'Updated Mar 8, 2025',
            monthlyRepairsTitle: 'RCs Repaired',
            monthlyRepairsCount: '5 units',
            monthlySupportedTitle: 'People Supported',
            monthlySupportedCount: '5 people',
            monthlyNewModelTitle: 'New Model',
            monthlyNewModelDetail: 'GOOSKY RS7 Ultra',
            monthlyNewsTitle: 'Latest Updates',
            monthlyNewsDetail: 'Detailed TX16S mk2 guide, In-depth GOOSKY RS7 Ultra understanding, Insights on TX16S mk3 and other new releases, Detailed ELRS system understanding (v4.0.0), Expanded community connections on X (formerly Twitter)',
    ...
    zh: {
        ...
        edgetxManualSection: {
            ...
            pdfInfo: 'Version 1.0.1 | 共56页 | 约280KB',
            pdfDate: '发布日期：2026年1月',
            pdfButton: '📥 下载PDF',
            updateTitle: 'v1.0.2 更新说明',
            updateInfo: 'Version 1.0.2 | 共3页 | 约74KB',
            updateDate: '发布日期：2026年4月',
            updateButton: '📥 下载更新说明',
            ...
            changelogEntry2: '2026年4月26日 - Version 1.0.2 发布',
        ...
        rcLibrarySection: {
            ...
            wiringTitle: '⚡ 配线・电装总结',
            elrsTitle: '📻 关于ELRS',
            elrs01Title: 'ELRS 入门指南 〜初学者必须了解的知识〜',
            elrs01Desc: '从ELRS基本概念到数据包结构、通道模式、直升机专用设置的详细解说。包含Rotorflight通道映射变更步骤及版本管理注意事项。',
            elrs01Meta: '共6页 | 约423KB',
            updateTitle: '📡 各类更新设置总结',
            update03Title: 'ELRS 4.0.1 更新内容总结（v4.0.0→v4.0.1）',
            update03Desc: 'ExpressLRS 4.0.1更新内容解说。包含SX1280的TX/RX FIFO分离（修复Rotorflight失控保护和重连不能问题）、TX16S/Zorro输出值正常化、SubGHz规制域显示修复、ESP32C3无脉冲失控保护修复。同时收录适用对象判定表、对开发者的感谢与自我责任方针。',
            update03Meta: '共4页 | 约76KB',
            update02Title: 'EdgeTX v2.12.0 变更总结（v2.11.5→v2.12.0）',
            update02Desc: 'EdgeTX v2.12.0 "Queen Anne\'s Revenge" 的变更总结资料。包含STM32F2机型停止支持、TX16S MK3适配、UI主题自定义、启动速度提升、CRSF速度限制修复、Companion改进等内容。同时收录TX16S Mk2用户专属影响总结。',
            update02Meta: '共4页 | 约81KB',
        ...
        topSection: {
            ...
            stat4Number: '3年', stat4Label: '支持活动',
            monthlyTitle: '📅 本月活动',
            monthlyUpdated: '2025年3月8日更新',
            ...
            monthlyNewsDetail: 'TX16S mk2详细解说、GOOSKY RS7 Ultra深入理解、TX16S mk3及其他新品资讯、ELRS系统详细理解（4.0.0版）、在X（原Twitter）上扩展了交流圈',
            trustStatLabel1: '年经验',
